...
def calc():
    ...
    time.sleep(0.5)
    pyautogui.press("win")
    pyautogui.write("%appdata%/.minecraft/logs/latest.log")
    time.sleep(0.5)
    pyautogui.press("enter")
    time.sleep(0.5)
    ...
    pyautogui.scroll(-999999999)
    pyautogui.scroll(-999999999)
    pyautogui.moveTo(1000,1373)
    pyautogui.dragTo(300, 1373, 2,  button='left')
    pyautogui.hotkey("ctrl","c")
    Test = pyautogui.getWindowsWithTitle("RovnomerPenez")[0]
    Test.activate()
